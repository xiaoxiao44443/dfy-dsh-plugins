...
test('appearance registers durable settings, a sidebar page, and artifact placements', async () => {
  ...
  assert.match(client, /installArtifactPlacements/);
  ...
  assert.match(client, /className="dsh-appearance-reset"/);
